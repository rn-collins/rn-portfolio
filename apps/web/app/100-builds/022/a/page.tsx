...
export const metadata:Metadata={title:'Build 022-A — Human Consequence Map for AI Workflows',description:'Show who can be affected by an AI workflow and how consequences travel to them.',alternates:{canonical:'/100-builds/022/a'}};
