...
,
 '021':{id:'021',title:'AI Vendor Claim / Procurement X-Ray',question:'What would have to be true before this vendor claim could support a procurement decision?',thesis:'A vendor promise becomes decision-ready only when the exact entity, proposition, evidence, scope, consequence, control, commitment, remedy, and correction path are explicit.',research:[{label:'Vendor Claim X-Ray v1',detail:'Four disclosed verification paths and three non-binary verdicts over synthetic claims.',path:'data/build-021-engine-v1.json'},{label:'NIST AI RMF 1.0',detail:'Grounds risk, context, measurement, governance, and documentation.',href:'https://nvlpubs.nist.gov/nistpubs/ai/NIST.AI.100-1.pdf'}],created:[{label:'021-A AI Vendor Claim / Procurement X-Ray',detail:'Breaks synthetic claims into evidence, scope, independent verification, and enforceable commitment.',href:'/100-builds/021/a'},{label:'021-B Break the Claim Open',detail:'Progressively reveals the verification path beneath one promise.',href:'/100-builds/021/b'},{label:'Claim Verification Record v1',detail:'Reusable vendor-claim evidence and gap primitives for Build 025.'}],decisions:[{label:'Canonical versus derived copy is explicit',detail:'Title, job, B-web, and lineage are canonical; question, thesis, fixtures, thresholds, and interface language are derived.'},{label:'Builds 011, 012, and 020 are concrete dependencies',detail:'The x-ray makes identity resolution, consequence controls, and reconstructable evidence visible.'},{label:'Verification is scope-specific',detail:'A closed claim does not endorse the vendor, product, or use outside the stated context.'}],audits:[{label:'Machine-readable archive',detail:'Routes, lineage, retention, and deferred gates.',path:'data/build-021-archive-v1.json'},{label:'Privacy/support',detail:'Synthetic client-local fixture and procurement boundary.',path:'data/build-021-privacy-support-v1.json'},{label:'Freshness/performance',detail:'Primary NIST sources and deterministic offline operation.',path:'data/build-021-freshness-performance-v1.json'},{label:'Browser fixtures',detail:'Verdicts, identity separation, export, 320px, and paired visual coverage.',path:'tests/build021.spec.ts'}],plans:[{label:'Release path',detail:'Complete static gates and Vercel deployment; keep authenticated browser, physical-device accessibility, GitHub-hosted CI, and media certification independent.'},{label:'Future consumer',detail:'025 consumes cap:021.'}],sourceFiles:['apps/web/app/100-builds/021/a/VendorClaimLab.tsx','apps/web/app/100-builds/021/b/ClaimXRay.tsx','data/build-021-engine-v1.json','data/build-021-archive-v1.json','docs/builds/021/SPEC.md','docs/builds/021/ARCHIVE.md','tests/build021.spec.ts']}
};
