...
<header className={room.label}><div className={room.accession}>BUILD 002-A<br/>ACTIVE PROTOTYPE</div><div><h1 style={{fontSize:'clamp(34px,8vw,116px)',overflowWrap:'anywhere'}}>Multi-Audience Meaning Architecture</h1><p>Change the language for the person in front of you without quietly changing the claim underneath it.</p></div></header>
