...
export const metadata:Metadata={title:'Build 007-B — The Product That Learns',description:'An interactive product flow that closes into a governed learning loop.',alternates:{canonical:'/100-builds/007/b'},openGraph:{title:'Build 007-B — The Product That Learns',description:'Move from one-way delivery to governed capture, decision, validation and communication.',type:'website'},twitter:{card:'summary_large_image',title:'Build 007-B — The Product That Learns',description:'A product learns only when feedback can responsibly change it.'}};
