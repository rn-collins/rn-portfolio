...
export const metadata:Metadata={title:'Build 009-B — Transfer Is a Place Question',description:'Place constraints reshape a technology feasibility map in real time.',alternates:{canonical:'/100-builds/009/b'}};
