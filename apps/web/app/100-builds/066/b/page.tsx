...
export default function Page(){return <main className={s.page} data-build="066" data-variant="B"><nav aria-label="Build navigation"><a href="/100-builds">100 BUILDS</a><span>066-B</span></nav><p className={s.kicker}>FILES HOLD DOCUMENTS. RELATIONSHIPS HOLD MEMORY.</p><h2>The firm knows more than its folders.</h2><FirmMemoryStory/></main>}
