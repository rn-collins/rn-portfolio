...
export default function BuildsPage(){
  return <main className={s.page}>
    ...
    <section className={s.intro}>
      ...
      <div className={s.introCopy}><p>I’m building one hundred useful things from questions I keep running into across technology, law, neuroscience, research, place, work, and everyday life.</p><p>You can use what is finished, look inside what I am building now, and see the frozen sequence ahead.</p><div className={s.progress} aria-label="Exhibition progress"><strong>3</strong><span>ON VIEW</span><strong>1</strong><span>IN THE LAB</span><strong>96</strong><span>COMING NEXT</span></div></div>
    </section>
    ...
    <section className={s.current} aria-labelledby="current-build"><div><span>CURRENTLY IN THE LAB / BUILD 004</span><h2 id="current-build">Manual Intelligence Engine Method</h2><p>What has to be true before research deserves automation?</p></div><Link href="/100-builds/004">SEE THE BUILD IN PROGRESS →</Link></section>
