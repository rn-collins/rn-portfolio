...
export default function BuildsPage(){
 return <main className={s.page}>
  ...
  <nav className={s.discovery} aria-label="Start here">
   ...
   <div><span>SEE THE SYSTEM</span><Link href="/100-builds/100">100 · The convergence</Link><Link href="/lineage">Capability lineage</Link><Link href="/100-builds/archive">Archive coverage</Link></div>
  </nav>
