...
export default function BuildsPage(){
  return <>
    <Script src="/data/100-builds.js" strategy="beforeInteractive" />
    <header className="topbar"><div className="shell nav"><a href="/">RN Builds</a><span className="mono">100 Builds</span></div></header>
